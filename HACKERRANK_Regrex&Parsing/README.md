In this folder there are all the execercises from the [Regex and Parsing](https://www.hackerrank.com/domains/python?filters%5Bsubdomains%5D%5B%5D=py-regex) challenge.<br>
